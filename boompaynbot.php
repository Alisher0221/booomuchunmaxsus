...
ob_start();
define("uzfox","1067919712:AAEESW4q8uCAfHcm0c_U6-guNl7cXrC7sRM");
$admin = "831477295";
$botname = "BoomPaynbot";
...
"inline_keyboard"=>[
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/xabarchilar"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/XAKKER_ZORO"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/Navoiy_SAMARQAND_bozor"],],
...
"photo"=>"https://t.me/ALISHER20020221/10",
    "caption"=>"✅ <b>BOOMPAYN tizimining rasmiy boti</b> 🤖\n\n🎈 $username do'stingizdan unikal havola-taklifnoma.\n\n👇 Boshlash uchun bosing:
...
"parse_mode"=>"markdown",
       ...
       uzfox("sendMessage",[
              ...
              "parse_mode"=>"html",
               "reply_markup"=>json_encode([   
   "inline_keyboard"=>[
[["text"=>"👨‍💻 Admin","url"=>"https://telegram.me/aloqa0221bot"],["text"=>"👥 Kanalimiz","url"=>"https://t.me/Boom_Payn"],],
]
]),
]);
}
...
"disable_web_page_preview"=>true,
"parse_mode"=>"html",
"message_text"=>"✅ <b>BOOMPAYN tizimining rasmiy boti</b> 🤖\n\n🎈 $username do'stingizdan unikal havola-taklifnoma.\n\n👇 Boshlash uchun bosing:
...
uzfox("sendMessage",[
   "chat_id"=>$chatid,
   "text"=>"Nima haqida yozmoqchisiz? 😊\n\n<b>📞 Aloqa markazi:</b> @BoompaymADMINbot",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"🗣 Bog'lanish","url"=>"https://t.me/BoompaymADMINbot"],],
]
]),
]);
}
